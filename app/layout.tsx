...
export const metadata: Metadata = {
  ...
  openGraph: { title:"Vaahan Safe Data Collector", description:"Plan the scope, know the load, and collect carefully.", images:["https://yashbhakat.github.io/vaahan-safe-collector/og.png"] },
  twitter: { card:"summary_large_image", title:"Vaahan Safe Data Collector", description:"Free responsible Vaahan collection planner.", images:["https://yashbhakat.github.io/vaahan-safe-collector/og.png"] },
};
